...
public class AdminController {
    ...
    @PostMapping("/live-rooms/whitelists/{meetingRoomId}")
    ...
    @DeleteMapping("/live-rooms/whitelists/{meetingRoomId}")
    ...
    @DeleteMapping("/live-rooms/whitelists")
    ...
    @GetMapping("/live-rooms/whitelists")
